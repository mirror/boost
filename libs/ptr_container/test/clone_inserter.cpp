...
#include <boost/ptr_container/clone_inserter.hpp> 
...
void test_clone_inserter_helper()
{
...
void test_clone_inserter()
{
    test_clone_inserter_helper< boost::ptr_list< boost::nullable<int> > >();
    test_clone_inserter_helper< boost::ptr_deque< boost::nullable<int> > >();
...
test_suite* init_unit_test_suite( int argc, char* argv[] )
{
    ...
    test->add( BOOST_TEST_CASE( &test_clone_inserter ) );
