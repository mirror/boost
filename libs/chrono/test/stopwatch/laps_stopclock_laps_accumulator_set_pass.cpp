...
void check_all()
{
  ...
  typedef stopclock<Clock, boost::chrono::laps_accumulator_set<typename Clock::duration> > Reporter;
  typedef stopclock<Clock, boost::chrono::laps_accumulator_set<typename Clock::duration>, elapsed_formatter > ReporterE;
