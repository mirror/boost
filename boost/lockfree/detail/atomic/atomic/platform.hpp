...
#include <boost/config.hpp>
	...
	#include <boost/lockfree/detail/atomic/atomic/detail/gcc-x86.hpp>

#elif defined(__GNUC__) && defined(__alpha__)

	#include <boost/lockfree/detail/atomic/atomic/detail/gcc-alpha.hpp>

#elif defined(__GNUC__) && (defined(__POWERPC__) || defined(__PPC__))

	#include <boost/lockfree/detail/atomic/atomic/detail/gcc-ppc.hpp>
...
// I don't know how complete it is.
	...
	#include <boost/lockfree/detail/atomic/atomic/detail/gcc-armv6+.hpp>

#elif defined(__linux__) && defined(__arm__)

	#include <boost/lockfree/detail/atomic/atomic/detail/linux-arm.hpp>
	...
	#include <boost/lockfree/detail/atomic/atomic/detail/interlocked.hpp>

#else

	#warning "Using slow fallback atomic implementation"
	#include <boost/lockfree/detail/atomic/atomic/detail/generic-cas.hpp>
