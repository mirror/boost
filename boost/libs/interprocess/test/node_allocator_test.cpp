...
/*  interprocess::list using the node allocator                  */
...
typedef node_allocator
   <int, 64, wmanaged_shared_memory::segment_manager> shmem_node_allocator_t;
...
int main ()
{
   ...
   MyShmList *shmlist = segment.construct<MyShmList>(L"MyList")
   ...
   segment.destroy<MyShmList>(L"MyList");
   delete stdlist;
   return 0;
}
