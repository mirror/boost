    ...
    static test_case const test_cases[] =
    {
      ...
      , test_case // test90
        (
            L("(boo[bar]baz)")
          , L("(\\(()|\\[()).*?(\\)\\2|\\]\\3)")
          , regex_type((s1= L('(') >> (s2= epsilon) | L('[') >> (s3= epsilon)) >> -*_ >> (s4= L(')') >> s2 | L(']') >> s3))
          , L("")
          , backrefs(L("(boo[bar]baz)"), L("("), L(""), L(""), L(")"), nil)
        )
      , test_case // test91
        (
            L("[boo(bar)baz]")
      ...
      , test_case // test91
        (
          ...
          , regex_type((s1= L('(') >> (s2= epsilon) | L('[') >> (s3= epsilon)) >> -*_ >> (s4= L(')') >> s2 | L(']') >> s3))
          , L("")
          , backrefs(L("[boo[bar]"), L("["), L(""), L(""), L("]"), nil)
        )
      , test_case // test92
        (
            L("foobarfoo")
      ...
      , test_case // test97
        (
          ...
          , L("")
          , backrefs(L("12foo12"), nil)
        )
      , test_case // test98
        (
            L("aaaa")
          , L("(?<=())a")
          , regex_type(after(s1= epsilon) >> L('a'))
          , L("")
          , backrefs(L("a"), L(""), nil)
        )
      , test_case // test99
