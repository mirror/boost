...
boost::iterator_range<test_case<BidiIterT> const *> get_test_cases()
{
    ...
    static test_case const test_cases[] =
    {
        ...
        (
          ...
          , L("")
          , backrefs(L("foobarFOObarfoo"), L("foo"), L("barFOObar"), nil)
        )
      , test_case // test42
        (
            L("foobarFOObarfoo")
          ...
          , L("")
          , backrefs(L("foobarFOO"), L("foo"), L("bar"), nil)
        )
      , test_case // test42.1
        (
            L("fooFOOOFOOOOObar")
          ...
          , L("")
          , backrefs(L("fooFOOOFOOOO"), L("FOOOO"), nil)
        )
      , test_case // test43
        (
            L("zoo")
      ...
      , test_case // test44
        (
          ...
          , regex_type((s1= L("http") >> !as_xpr(L('s')) >> L(":/") | L("www."))
                        ...
                        >> _w)
          , L("")
          , backrefs(L("http://www.cnn.com"), L("http:/"), nil)
        )
      , test_case // test45
        (
            L("fooooooooo")
      ...
      , test_case // test60
        (
          ...
          , L("i")
          , backrefs(L("fooFOObar"), L("foo"), nil)
        )
    };
