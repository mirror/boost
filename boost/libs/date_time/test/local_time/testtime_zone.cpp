...
main()
{
  ...
  boost::shared_ptr<time_zone_base> tz2(new time_zone(pst, hours(-8), of, rule2));
  boost::shared_ptr<time_zone_base> tz3(new time_zone(pst, hours(-8), of, rule3));
  boost::shared_ptr<time_zone_base> tz4(new time_zone(mst, hours(-7), of2, rule4));
