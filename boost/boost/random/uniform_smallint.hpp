...
#else
  typedef typename detail::uniform_smallint<boost::is_float<typename UniformRandomNumberGenerator::result_type>::value == false>::impl<UniformRandomNumberGenerator, IntType>::type impl_type;
#endif
