...
namespace boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        matrix_row &operator = (const matrix_row &mr) {
            ...
            vector_assign (scalar_assign<BOOST_UBLAS_TYPENAME iterator::reference, BOOST_UBLAS_TYPENAME vector_temporary_type::value_type> (), *this, vector_temporary_type (mr));
            return *this;
        }
        BOOST_UBLAS_INLINE
    ...
    public:
        ...
        matrix_vector_range &operator = (const matrix_vector_range &mvr) {
            ...
            vector_assign (scalar_assign<BOOST_UBLAS_TYPENAME iterator::reference, BOOST_UBLAS_TYPENAME vector_temporary_type::value_type> (), *this, vector_temporary_type (mvr));
            return *this;
        }
        BOOST_UBLAS_INLINE
    ...
    private:
        ...
        typedef BOOST_UBLAS_TYPENAME range_type::const_iterator const_iterator1_type;
        typedef BOOST_UBLAS_TYPENAME range_type::const_iterator iterator1_type;
        typedef BOOST_UBLAS_TYPENAME range_type::const_iterator const_iterator2_type;
        typedef BOOST_UBLAS_TYPENAME range_type::const_iterator iterator2_type;
    ...
    public:
        ...
        matrix_vector_slice &operator = (const matrix_vector_slice &mvs) {
            ...
            vector_assign (scalar_assign<BOOST_UBLAS_TYPENAME iterator::reference, BOOST_UBLAS_TYPENAME vector_temporary_type::value_type> (), *this, vector_temporary_type (mvs));
            return *this;
        }
        BOOST_UBLAS_INLINE
    ...
    private:
        ...
        typedef BOOST_UBLAS_TYPENAME slice_type::const_iterator const_iterator1_type;
        typedef BOOST_UBLAS_TYPENAME slice_type::const_iterator iterator1_type;
        typedef BOOST_UBLAS_TYPENAME slice_type::const_iterator const_iterator2_type;
        typedef BOOST_UBLAS_TYPENAME slice_type::const_iterator iterator2_type;
    ...
    public:
        ...
        matrix_vector_indirect &operator = (const matrix_vector_indirect &mvi) {
            ...
            vector_assign (scalar_assign<BOOST_UBLAS_TYPENAME iterator::reference, BOOST_UBLAS_TYPENAME vector_temporary_type::value_type> (), *this, vector_temporary_type (mvi));
            return *this;
        }
        BOOST_UBLAS_INLINE
    ...
    public:
        ...
        matrix_range &operator = (const matrix_expression<AE> &ae) {
            matrix_assign (scalar_assign<BOOST_UBLAS_TYPENAME iterator1::reference, BOOST_UBLAS_TYPENAME matrix_temporary_type::value_type> (), *this, matrix_temporary_type (ae));
            return *this;
        }
        template<class AE>
        BOOST_UBLAS_INLINE
        ...
        BOOST_UBLAS_INLINE
        matrix_range& operator += (const matrix_expression<AE> &ae) {
            matrix_assign (scalar_assign<BOOST_UBLAS_TYPENAME iterator1::reference, BOOST_UBLAS_TYPENAME matrix_temporary_type::value_type> (), *this, matrix_temporary_type (*this + ae));
            return *this;
        }
        template<class AE>
        BOOST_UBLAS_INLINE
    ...
    template<class M>
    BOOST_UBLAS_INLINE
    const matrix_range<const M> project_const (const M &data, const typename matrix_range<M>::range_type &r1, const typename matrix_range<M>::range_type &r2) {
    ...
    template<class M>
    BOOST_UBLAS_INLINE
    const matrix_slice<const M> project_const (const M &data, const typename matrix_slice<M>::slice_type &s1, const typename matrix_slice<M>::slice_type &s2) {
