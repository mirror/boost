...
#            define BOOST_PP_BOOL(x) BOOST_PP_EVIL_BOOL_D((x))
#            define BOOST_PP_EVIL_BOOL_D(par) BOOST_PP_BOOL_D ## par
#        else
#            define BOOST_PP_BOOL(x) BOOST_PP_BOOL_D(x)
#        endif
#        define BOOST_PP_BOOL_D(x) BOOST_PP_COMPL(BOOST_PP_IS_NULLARY(BOOST_PP_BOOL_ ## x))
#    endif
