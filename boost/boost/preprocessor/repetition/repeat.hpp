...
#    define BOOST_PP_REPEAT_2(c, m, d) BOOST_PP_CAT(BOOST_PP_REPEAT_2_, c)(m, d)
#    define BOOST_PP_REPEAT_3(c, m, d) BOOST_PP_CAT(BOOST_PP_REPEAT_3_, c)(m, d)
# else
#    define BOOST_PP_REPEAT_1(c, m, d) BOOST_PP_REPEAT_1_D(c, m, d)
#    define BOOST_PP_REPEAT_2(c, m, d) BOOST_PP_REPEAT_2_D(c, m, d)
#    define BOOST_PP_REPEAT_3(c, m, d) BOOST_PP_REPEAT_3_D(c, m, d)
#    define BOOST_PP_REPEAT_1_D(c, m, d) BOOST_PP_REPEAT_1_ ## c(m, d)
#    define BOOST_PP_REPEAT_2_D(c, m, d) BOOST_PP_REPEAT_2_ ## c(m, d)
#    define BOOST_PP_REPEAT_3_D(c, m, d) BOOST_PP_REPEAT_3_ ## c(m, d)
# endif
#
...
#    include <boost/preprocessor/repetition/detail/unrolled.hpp>
# else
