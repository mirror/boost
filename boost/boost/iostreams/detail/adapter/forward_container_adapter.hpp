...
#ifndef BOOST_IOSTREAMS_DETAIL_FORWARD_CONTAINER_ADAPTER_HPP_INCLUDED
#define BOOST_IOSTREAMS_DETAIL_FORWARD_CONTAINER_ADAPTER_HPP_INCLUDED
...
class forward_container_adapter {
public:
    ...
    struct io_category 
        : device_tag,
          Mode
        { };
    forward_container_adapter()
        : pimpl_(new impl(new Container(), true)) { }
    forward_container_adapter(const Container& cnt)
        : pimpl_(new impl(new Container(cnt), true)) { }
    forward_container_adapter(const reference_wrapper<Container>& ref)
...
#endif // #ifndef BOOST_IOSTREAMS_DETAIL_FORWARD_CONTAINER_ADAPTER_HPP_INCLUDED
