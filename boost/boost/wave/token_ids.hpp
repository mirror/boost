...
enum token_id {
    ...
    T_FIXEDPOINTLIT = TOKEN_FROM_ID(388, FloatingLiteralTokenType|AltTokenType),  // IDL specific
    T_CCOMMENT     = TOKEN_FROM_ID(389, WhiteSpaceTokenType),
    T_CPPCOMMENT   = TOKEN_FROM_ID(390, WhiteSpaceTokenType),
    T_CHARLIT      = TOKEN_FROM_ID(391, CharacterLiteralTokenType),
    T_STRINGLIT    = TOKEN_FROM_ID(392, StringLiteralTokenType),
    T_CONTLINE     = TOKEN_FROM_ID(393, EOLTokenType),
    T_SPACE        = TOKEN_FROM_ID(394, WhiteSpaceTokenType),
    T_SPACE2       = TOKEN_FROM_ID(395, WhiteSpaceTokenType),
    T_NEWLINE      = TOKEN_FROM_ID(396, EOLTokenType),
